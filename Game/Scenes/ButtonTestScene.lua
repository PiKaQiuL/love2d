...
function ButtonTestScene:enter()
    ...
    -- 根布局容器
    self.root = Layout(40, 40, 360, 240, {
    ...
    local b1 = Button("Click Me", 0, 0, 140, 32, { onClick = onClick })
    local b2 = Button("Disabled", 0, 0, 140, 32, { onClick = onClick, disabled = true })
    local b3 = Button("Focused", 0, 0, 140, 32, { onClick = onClick, focused = true })
    local b4 = Button("Wide Button", 0, 0, 220, 32, { onClick = onClick })
    local b5 = Button("Danger", 0, 0, 140, 32, {
        onClick = onClick,
        colors = {
